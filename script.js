                        ...
                        <div>
                          ...
                          <div>
                            <a href="tel:${item.cell}"
                              ><i class="bi bi-phone-fill"></i>${item.cell}</a
                            >
                          </div>
                          <div>
                          ...
                          <div>
                            <a
                              href="https://www.google.com/maps/place/${item.location.street.name}+${item.location.street.number}+
                              ${item.location.state}+ ${item.location.country}"
                              target="_blank"
                              ><i class="bi bi-globe-asia-australia-fill"></i> ${item.location.street.name} ${item.location.street.number}
                             ${item.location.state} ${item.location.country} </a
                            >
                          </div>
                        </div>
                      </div>
